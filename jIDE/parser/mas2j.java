...
public class mas2j implements mas2jConstants {
    ...
    public static void main (String args[]) {
      ...
      try {
                project = parser.mas();
        project.setJasonJar(args[1]+"/bin/jason.jar");
        project.setLog4jJar(args[1]+"/lib/log4j.jar");
        project.setSaciJar(args[1]+"/lib/saci.jar");
        project.setProjectDir(new File(".").getAbsolutePath());
