...
/* Configuration Grammar */
  ...
  final public void agent() throws ParseException {
    ...
    opts = ASoptions();
                              ...
                              String agArchClass = jason.architecture.SaciAgArch.class.getName();

                              if (architecture.equals("Centralised")) {
                                  agArchClass = jason.architecture.CentralisedAgArch.class.getName();
                              }
    switch ((jj_ntk==-1)?jj_ntk():jj_ntk) {
    case ASAGARCHCLASS:
